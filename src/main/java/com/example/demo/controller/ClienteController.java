...
import com.example.demo.service.ClienteService;  // Asegúrate de que el servicio ClienteService esté importado
...
@RestController
@RequestMapping("/clientes")  // Mapea las rutas de la API para trabajar con clientes
