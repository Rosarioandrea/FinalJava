...
import com.example.demo.entities.Venta;  // Asegúrate de tener la entidad Venta importada
import com.example.demo.service.VentaService;  // Asegúrate de tener el servicio VentaService importado
...
@RestController
@RequestMapping("/ventas")  // Mapea las rutas de la API para trabajar con ventas
