...
import com.example.demo.entities.Producto;  // Asegúrate de tener la entidad Producto importada
import com.example.demo.service.ProductoService;  // Asegúrate de tener el servicio ProductoService importado
...
@RestController
@RequestMapping("/productos")  // Mapea las rutas de la API para trabajar con productos
